    ...
    <footer className="bg-black text-white px-5 md:px-20">
      ...
      <div className="max-w-7xl mx-auto py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Link to="/about-us" className="block text-gray-400 hover:text-yellow-500 transition-colors duration-200 text-sm border-b border-gray-700 pb-1">
              About Us
            </Link>
            <Link to="/contact-us" className="block text-gray-400 hover:text-yellow-500 transition-colors duration-200 text-sm border-b border-gray-700 pb-1">
              Contact Us
            </Link>
            <Link to="/terms-conditions" className="block text-gray-400 hover:text-yellow-500 transition-colors duration-200 text-sm border-b border-gray-700 pb-1">
              Terms & Conditions
            </Link>
            <Link to="/privacy-policy" className="block text-gray-400 hover:text-yellow-500 transition-colors duration-200 text-sm border-b border-gray-700 pb-1">
              Privacy Policy
            </Link>
            <Link to="/refund-cancellation" className="block text-gray-400 hover:text-yellow-500 transition-colors duration-200 text-sm border-b border-gray-700 pb-1">
              Refund & Cancellation
            </Link>
            <Link to="/delivery-policy" className="block text-gray-400 hover:text-yellow-500 transition-colors duration-200 text-sm border-b border-gray-700 pb-1">
              Delivery Policy
            </Link>
          </div>
        </div>
      ...
      <div className="py-4 text-center text-gray-500 text-sm w-full border-t border-gray-700">
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
          ...
          <p className="text-xs">
            Secure payments powered by <span className="text-blue-400">Razorpay</span> | 
            <Link to="/privacy-policy" className="text-yellow-500 hover:text-yellow-400 ml-1">
